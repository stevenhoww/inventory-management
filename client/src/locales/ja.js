export default {
  ...
  orders: {
    ...
    allOrders: 'すべての注文',
    submittedOrders: '送信済み注文（このセッション）',
    totalOrders: '総注文数',
    totalRevenue: '総収益',
    avgOrderValue: '平均注文額',
    onTimeDelivery: '定時配達',
    itemsCount: '{count}件',
    quantity: '数量',
    sessionNotice: 'セッション内のみの注文',
    sessionNoticeMessage: 'このセッション中に送信された注文は、ページを更新するとクリアされます。',
    table: {
      orderNumber: '注文番号',
      orderId: '注文ID',
      orderDate: '注文日',
  ...
  restocking: {
    title: '再仕入',
    description: '需要予測に基づいて再仕入注文を計画・送信',
    budgetAllocation: '予算配分',
    availableBudget: '利用可能な予算',
    recommendedCost: '推奨コスト',
    remaining: '残り予算',
    setBudget: '予算を設定してください（$0 - $10,000）',
    recommendations: '品目の推奨',
    noRecommendations: '予算内に利用可能な品目がありません',
    increaseBudget: '予算を増やして推奨を確認してください',
    selectAll: 'すべて選択',
    deselectAll: 'すべての選択を解除',
    orderPreview: '注文プレビュー',
    itemsSelected: '選択した品目',
    totalUnits: '総ユニット数',
    estimatedCost: '推定コスト',
    deliveryTime: '推定配達',
    days: '日',
    placeOrder: '注文を送信',
    budgetExceeded: '予算を超過しています',
    budgetExceededMessage: '予算内に収まるようにいくつかの品目を選択解除してください。',
    submittedOrders: '送信済み注文（このセッション）',
    sessionOnlyNotice: 'セッション内のみの注文',
    sessionOnlyMessage: 'このセッション中に送信された注文は、ページを更新するとクリアされます。',
    table: {
      sku: 'SKU',
      itemName: '品目名',
      forecastedDemand: '予測需要',
