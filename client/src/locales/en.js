export default {
  ...
  orders: {
    ...
    submittedOrders: 'Submitted Orders (This Session)',
    totalOrders: 'Total Orders',
    ...
    quantity: 'Qty',
    sessionNotice: 'Session-Only Orders',
    sessionNoticeMessage: 'Orders submitted in this session will be cleared when you refresh the page.',
    table: {
  ...
  restocking: {
    ...
    setBudget: 'Set Your Budget ($0 - $10,000)',
    recommendations: 'Item Recommendations',
    noRecommendations: 'No items available within your budget',
    increaseBudget: 'Try increasing your budget to see recommendations',
    ...
    budgetExceededMessage: 'Deselect some items to fit within your budget.',
    submittedOrders: 'Submitted Orders (This Session)',
    sessionOnlyNotice: 'Session-Only Orders',
    sessionOnlyMessage: 'Orders submitted during this session will be cleared when you refresh the page.',
    table: {
      sku: 'SKU',
      itemName: 'Item Name',
      forecastedDemand: 'Forecasted Demand',
